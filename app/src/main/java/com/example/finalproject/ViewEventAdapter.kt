...
class ViewEventAdapter(val peopleList: List<Int>, val viewModel: EventViewModel, val event: Event, val activity: FragmentActivity?) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewEventViewHolder {
        ...
        return ViewEventViewHolder(binding, viewModel, event, this, activity)
    }
